...
[['Mogens', None, None, None], ['Mogens', None, None, None], ['Mogens', None, None, None]]
        ...
        self.assertTrue(
            all(x is not y for x, y in itertools.combinations(m, 2)), message
        )
...
@unittest.skipIf(
    function_not_defined(project, "get_traceback_arrow"), "get_traceback_arrow"
)
...
class TestAlign(AnvProgTestCase):
    def test_align_1(self):
        self.assertEqualNice(
            ["G-C", "GTC"], project.align, "GC", "GTC", score_matrix, -1
        )

    def test_align_2(self):
        self.assertEqualNice(
            ["-AT", "GAT"], project.align, "AT", "GAT", score_matrix, -1
        )

    def test_align_3(self):
        self.assertEqualNice(
            ["-AT-AT", "GATGAT"], project.align, "ATAT", "GATGAT", score_matrix, -1
        )
