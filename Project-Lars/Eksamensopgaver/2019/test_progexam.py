...
@unittest.skipIf(function_not_defined(project, 'longest_sequence'), 'longest_sequence')
class Test_longest_sequence(AnvProgTestCase):

    def test_longest_sequence_1(self):
        self.assertEqualNice(
            'ATGC',
            project.longest_sequence, 'ATGC', 'ATG')

    def test_longest_sequence_2(self):
        self.assertEqualNice(
            'AAA',
            project.longest_sequence, 'TT', 'AAA')
    

@unittest.skipIf(function_not_defined(project, 'numbers_of_bases'), 'numbers_of_bases')
class Test_numbers_of_bases(AnvProgTestCase):

    def test_numbers_of_bases_1(self):
        self.assertEqualNice(
            {'A': 1, 'T': 1, 'G': 1, 'C':1},
            project.numbers_of_bases, 'ATGC')

    def test_numbers_of_bases_2(self):
        self.assertEqualNice(
            {'A': 2, 'T': 2, 'G': 2, 'C':2},
            project.numbers_of_bases, 'ATGCATGC')

    def test_numbers_of_bases_3(self):
        self.assertEqualNice(
            {'A': 0, 'T': 0, 'G': 4, 'C':0},
            project.numbers_of_bases, 'GGGG')

    def test_numbers_of_bases_4(self):
        self.assertEqualNice(
            {'A': 0, 'T': 0, 'G': 4, 'C': 2},
            project.numbers_of_bases, 'GGCCGG')
    

@unittest.skipIf(function_not_defined(project, 'numbers_of_triplets'), 'numbers_of_triplets')
class Test_numbers_of_triplets(AnvProgTestCase):

    def test_numbers_of_triplets_1(self):
        self.assertEqualNice(
            {'AAA': 1}, project.numbers_of_triplets, 'AAA')

    def test_numbers_of_triplets_2(self):
        self.assertEqualNice(
            {'AAA': 4}, project.numbers_of_triplets, 'AAAAAA')

    def test_numbers_of_triplets_3(self):
        self.assertEqualNice(
            {'AGT': 1, 'GTT': 1, 'TTT': 2}, project.numbers_of_triplets, 'AGTTTT')

    def test_numbers_of_triplets_4(self):
        self.assertEqualNice(
            {}, project.numbers_of_triplets, '')


@unittest.skipIf(function_not_defined(project, 'most_common_triplet'), 'most_common_triplet')
class Test_most_common_triplet(AnvProgTestCase):

    def test_most_common_triplet_1(self):
        self.assertEqualNice(
            'TTT',
            project.most_common_triplet, {'AGT': 1, 'GTT': 1, 'TTT': 2})
    
    def test_most_common_triplet_2(self):
        self.assertEqualNice(
            'ATT',
            project.most_common_triplet, {'ATT': 4, 'GTT': 1, 'CCC': 2})
            
    def test_most_common_triplet_3(self):
        self.assertEqualNice(
            'CCC',
            project.most_common_triplet, {'GTT': 1, 'CCC': 2})
    
    def test_most_common_triplet_4(self):
        self.assertEqualNice(
            'GGT',
            project.most_common_triplet, {'GGT': 1})


@unittest.skipIf(function_not_defined(project, 'column_sums'), 'column_sums')
class Test_column_sums(AnvProgTestCase):

    def test_column_sums_1(self):
        self.assertEqualNice(
            [4, 6],
            project.column_sums, [[1, 2], [3, 4]])

    def test_column_sums_2(self):
        self.assertEqualNice(
            [1, 0],
            project.column_sums, [[0, 0], [1, 0]])            
    
    def test_column_sums_3(self):
        self.assertEqualNice(
            [3, 6, 9],
            project.column_sums, [[1, 2, 3], [1, 2, 3], [1, 2, 3]])
    

@unittest.skipIf(function_not_defined(project, 'mean_base_dist'), 'mean_base_dist')
class Test_mean_base_dist(AnvProgTestCase):

    def test_mean_base_dist_1(self):
        self.assertEqualNice(
            2,
            project.mean_base_dist, 'AAAAA', 'A')
    
    def test_mean_base_dist_2(self):
        self.assertEqualNice(
            4,
            project.mean_base_dist, 'ATTATTAT', 'A')
    
    def test_mean_base_dist_3(self):
        self.assertEqualNice(
            None,
            project.mean_base_dist, 'AGAGAGA', 'T')
        
    def test_mean_base_dist_4(self):
        self.assertEqualNice(
            3,
            project.mean_base_dist, 'TCCT', 'T')

    def test_mean_base_dist_5(self):
        self.assertEqualNice(
            None,
            project.mean_base_dist, 'TCCT', 'A')
    

@unittest.skipIf(function_not_defined(project, 'find_differences'), 'find_differences')
class Test_find_differences(AnvProgTestCase):

    def test_find_differences_1(self):
        self.assertEqualNice(
            [1, 4],
            project.find_differences, 'AAAAAA', 'ATAATA')
    
    
    def test_find_differences_2(self):
        self.assertEqualNice(
            [],
            project.find_differences, 'AAAAAA', 'AAAAAA')
        

    def test_find_differences_3(self):
        self.assertEqualNice(
            [0, 1, 2, 3],
            project.find_differences, 'AAAA', 'TTTT')


    def test_find_differences_4(self):
        self.assertEqualNice(
            [0],
            project.find_differences, 'A', 'T')


@unittest.skipIf(function_not_defined(project, 'lowercase_differences'), 'lowercase_differences')
class Test_lowercase_differences(AnvProgTestCase):

    def test_lowercase_differences_1(self):
        self.assertEqualNice(
            ['AtA', 'AaA'],
            project.lowercase_differences, 'ATA', 'AAA')
    
    def test_lowercase_differences_2(self):
        self.assertEqualNice(
            ['ttt', 'ggg'],
            project.lowercase_differences, 'TTT', 'GGG')

    def test_lowercase_differences_3(self):
        self.assertEqualNice(
            ['TTT', 'TTT'],
            project.lowercase_differences, 'TTT', 'TTT')

    def test_lowercase_differences_4(self):
        self.assertEqualNice(
            ['tTt', 'aTg'],
            project.lowercase_differences, 'TTT', 'ATG')


@unittest.skipIf(function_not_defined(project, 'get_subsequences'), 'get_subsequences')
class Test_get_subsequences(AnvProgTestCase):

    def test_get_subsequences_1(self):
        self.assertEqualNice(
            ['A', 'AT', 'G', 'T', 'TG'],
             project.get_subsequences, 'ATG')
    
    def test_get_subsequences_2(self):
        self.assertEqualNice(
            ['A', 'AT', 'ATG', 'C', 'G', 'GC', 'T', 'TG', 'TGC'],
             project.get_subsequences, 'ATGC')

    def test_get_subsequences_3(self):
        self.assertEqualNice(
            ['A', 'T'],
             project.get_subsequences, 'AT')


@unittest.skipIf(function_not_defined(project, 'get_shared_subsequences'), 'get_shared_subsequences')
class Test_get_shared_subsequences(AnvProgTestCase):

    def test_get_shared_subsequences_1(self):
        self.assertEqualNice(
            ['T', 'TT'],
            project.get_shared_subsequences, 'AATTA', ['TTTT', 'TTCC'])

    def test_get_matches_2(self):
        self.assertEqualNice(
            ['T', 'TT'],
            project.get_shared_subsequences, 'AATT', ['TTGG', 'CTTC', 'TTTT'])
    
    def test_get_matches_3(self):
        self.assertEqualNice(
            ['A', 'AT', 'ATG', 'G', 'T', 'TG'],
            project.get_shared_subsequences, 'AATG', ['ATGT', 'CATG'])

    def test_get_matches_4(self):
        self.assertEqualNice(
            [],
            project.get_shared_subsequences, 'AAAA', ['TTTT', 'CCCC', 'GGGG'])

    def test_get_matches_4(self):
        self.assertEqualNice(
            [],
            project.get_shared_subsequences, 'AATT', ['GGGG', 'CGTC', 'TTTT'])
